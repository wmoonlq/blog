...
const effectsList = [
  { title: '粒子星云', sub: '900 颗粒子在暗夜中流转', component: ParticleNebula, canvas: true, wide: true },
  ...
  { title: '粒子玫瑰', sub: '四千粒子，聚成一朵玫瑰', component: ParticleRose, canvas: true, tall: true },
  ...
  { title: '波形网格', sub: '正弦波在网格上起伏', component: WaveGrid, canvas: true, wide: true },
  ...
  { title: '莫比乌斯环', sub: '线框环结，永无止境', component: KnotWire, canvas: true, tall: true },
...
<template>
  <div class="page">
    <header class="hero">
      ...
      <p class="hero-sub">一些在克制配色下仍然好看的动效 · 全局设置请点右上角 ⚙</p>
    </header>
    <div class="effects-grid">
      ...
      >
        <div class="effect-head">
          ...
          <span class="effect-num">{{ String(i + 1).padStart(2, '0') }}</span>
        </div>
